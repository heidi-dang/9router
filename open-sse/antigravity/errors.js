export const AntigravityErrorCode = Object.freeze({
  ...
  QUOTA_EXHAUSTED: "QUOTA_EXHAUSTED", CREDITS_EXHAUSTED: "CREDITS_EXHAUSTED", RATE_LIMITED: "RATE_LIMITED", CAPACITY_LIMITED: "CAPACITY_LIMITED",
...
export function classifyAntigravityError(status, message = "", details = {}) {
  ...
  else if (/insufficient_g1_credits_balance|credits.*exhausted/.test(lower)) code = AntigravityErrorCode.CREDITS_EXHAUSTED;
